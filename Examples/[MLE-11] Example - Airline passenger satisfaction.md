...
The main objective of this data could be to predict whether a future customer would be satisfied with their service given the values of the other parameters. A second objective could to be explore which aspects of the services offered have to be emphasized to generate more satisfied customers.
